...
use crate::{
    ...
    instructions::{
        ...
        DecreaseValidatorStake as DecreaseValidatorStakeIxAccounts,
        DecreaseValidatorStakeInstructionArgs as DecreaseValidatorStakeIxData,
        DepositSol as DepositSolIxAccounts, DepositSolInstructionArgs as DepositSolIxData,
        DepositStake as DepositStakeIxAccounts,
        IncreaseValidatorStake as IncreaseValidatorStakeIxAccounts,
        IncreaseValidatorStakeInstructionArgs as IncreaseValidatorStakeIxData,
        Initialize as InitializeIxAccounts, InitializeInstructionArgs as InitializeIxData,
        RemoveValidatorFromPool as RemoveValidatorFromPoolIxAccounts, SetFee as SetFeeIxAccounts,
        SetFeeInstructionArgs as SetFeeIxData,
        SetFundingAuthority as SetFundingAuthorityIxAccounts,
        SetFundingAuthorityInstructionArgs as SetFundingAuthorityIxData,
        SetManager as SetManagerIxAccounts,
        SetPreferredValidator as SetPreferredValidatorIxAccounts,
        SetPreferredValidatorInstructionArgs as SetPreferredValidatorIxData,
        SetStaker as SetStakerIxAccounts,
        UpdateStakePoolBalance as UpdateStakePoolBalanceIxAccounts,
        UpdateTokenMetadata as UpdateTokenMetadataIxAccounts,
        UpdateTokenMetadataInstructionArgs as UpdateTokenMetadataIxData,
        UpdateValidatorListBalance as UpdateValidatorListBalanceIxAccounts,
        UpdateValidatorListBalanceInstructionArgs as UpdateValidatorListBalanceIxData,
        WithdrawSol as WithdrawSolIxAccounts, WithdrawSolInstructionArgs as WithdrawSolIxData,
...
/// SplStakePool Instructions
#[derive(Debug)]
pub enum SplStakePoolProgramIx {
    Initialize(InitializeIxAccounts, InitializeIxData),
    AddValidatorToPool(AddValidatorToPoolIxAccounts),
    RemoveValidatorFromPool(RemoveValidatorFromPoolIxAccounts),
    DecreaseValidatorStake(
        DecreaseValidatorStakeIxAccounts,
        DecreaseValidatorStakeIxData,
    ),
    IncreaseValidatorStake(
        IncreaseValidatorStakeIxAccounts,
        IncreaseValidatorStakeIxData,
    ),
    SetPreferredValidator(SetPreferredValidatorIxAccounts, SetPreferredValidatorIxData),
    UpdateValidatorListBalance(
        UpdateValidatorListBalanceIxAccounts,
        UpdateValidatorListBalanceIxData,
    ),
    UpdateStakePoolBalance(UpdateStakePoolBalanceIxAccounts),
    CleanupRemovedValidatorEntries(CleanupRemovedValidatorEntriesIxAccounts),
    DepositStake(DepositStakeIxAccounts),
    WithdrawStake(WithdrawStakeIxAccounts, WithdrawStakeIxData),
    SetManager(SetManagerIxAccounts),
    SetFee(SetFeeIxAccounts, SetFeeIxData),
    SetStaker(SetStakerIxAccounts),
    DepositSol(DepositSolIxAccounts, DepositSolIxData),
    SetFundingAuthority(SetFundingAuthorityIxAccounts, SetFundingAuthorityIxData),
    WithdrawSol(WithdrawSolIxAccounts, WithdrawSolIxData),
    CreateTokenMetadata(CreateTokenMetadataIxAccounts, CreateTokenMetadataIxData),
    UpdateTokenMetadata(UpdateTokenMetadataIxAccounts, UpdateTokenMetadataIxData),
}
...
impl yellowstone_vixen_core::Parser for InstructionParser {
    ...
    type Output = SplStakePoolProgramIx;

    fn id(&self) -> std::borrow::Cow<str> {
        "SplStakePool::InstructionParser".into()
    }
...
impl InstructionParser {
    pub(crate) fn parse_impl(
    ...
    ) -> yellowstone_vixen_core::ParseResult<SplStakePoolProgramIx> {
        ...
        match ix_discriminator {
            [175, 175, 109, 31, 13, 152, 155, 237] => {
                ...
                Ok(SplStakePoolProgramIx::Initialize(ix_accounts, de_ix_data))
            }
            [181, 6, 29, 25, 192, 211, 190, 187] => {
                check_min_accounts_req(accounts_len, 13)?;
                let ix_accounts = AddValidatorToPoolIxAccounts {
                    stake_pool: ix.accounts[0].0.into(),
                ...
                Ok(SplStakePoolProgramIx::AddValidatorToPool(ix_accounts))
            }
